			  ...
			  <el-form :inline="true" :model="politicsWeb" class="demo-form-inline">
				...
				<template class="politicalFigures" v-if="isPoliticalFigures">
					...
					<div class="levelDescription">
						<h5>政治人物影响等级说明</h5>
						<el-table :data="Level" style="width: 100%">
							<el-table-column prop="level" label="等级名称" min-width="25%">
							</el-table-column>
							<el-table-column prop="levelDesc" label="等级描述" min-width="25%">
							</el-table-column>
							<el-table-column prop="levelDetails" label="计算分数范围" min-width="25%">
							</el-table-column>
						</el-table>
					</div>
				</template>
				...
				<template class="politicalMeetings" v-if="isPoliticalMeetings">
					...
					<el-table ref="multipleTable" :data="politicalMeetings" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" key="e">
						...
						<el-table-column prop="impactLevel" label="影响等级" min-width="20%">
						</el-table-column>
						<el-table-column fixed="right" label="操作" min-width="20%">
							<template slot-scope="scope">
