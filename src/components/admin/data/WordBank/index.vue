<template>
	<div>
		...
		<div class="content">
			...
			<!-- 世界银行 表格分页-->
			<el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="GTDFormData.pageNum" :page-sizes="[10,20,30]" :page-size="GTDFormData.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total">
			</el-pagination>
		</div>
	</div>
</template>
