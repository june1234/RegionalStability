...
export default {
  ...
  methods: {
    line() {
      ...
      var a4 = this.all.data.topic4;
      var a5 = this.all.data.topic5;
      var a6 = this.all.data.topic6;
      var a7 = this.all.data.topic7;
      var a8 = this.all.data.topic8;
      var a9 = this.all.data.topic9;
      var a10 = this.all.data.topic10;
      var a11 = this.all.data.topic11;
      var a12 = this.all.data.topic12;
      var a13 = this.all.data.topic13;
      var a14 = this.all.data.topic14;
      var a15 = this.all.data.topic15;
