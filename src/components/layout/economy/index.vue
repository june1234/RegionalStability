<template>
	<div class="EconomyEventAnalysis">
		...
		<el-form :inline="true" :model="economyFormData" ref="economyFormData">
			<el-form-item prop="countryId">
				<el-select v-model="economyFormData.countryId" multiple filterable placeholder="请选择国家">
					<el-option
			...
			<el-form-item prop="eventTime">
				<el-date-picker v-model="economyFormData.eventTime" type="date" placeholder="请输入开始时间"></el-date-picker>
			</el-form-item>
			<el-form-item prop="endTime">
				<el-date-picker v-model="economyFormData.endTime" type="date" placeholder="请输入结束时间"></el-date-picker>
			</el-form-item>
			<el-form-item>
		...
		<div class="content">
			<el-row :gutter="20">
				<el-col :span="8">
					<div class="grid-content">
						...
						<el-table :data="CPITableData" border>
							<el-table-column prop="countryfullname" label="国家" align="center" min-width="100%"></el-table-column>
							<el-table-column prop="year" label="时间(年)" align="center" min-width="100%"></el-table-column>
							<el-table-column prop="growth" label="增长率" align="center" min-width="100%"></el-table-column>
						</el-table> 
					</div>
				</el-col>
				<el-col :span="8">
					<div class="grid-content">
						...
						<el-table :data="GDPTableData" border>
							<el-table-column prop="countryfullname" label="国家" align="center" min-width="100%"></el-table-column>
							<el-table-column prop="year" label="时间(年)" align="center" min-width="100%"></el-table-column>
							<el-table-column prop="growth" label="增长率" align="center" min-width="100%"></el-table-column>
						</el-table>
				...
				<el-col :span="8">
					<div class="grid-content">
						...
						<el-table :data="StockPointTableData" border>
							<el-table-column prop="countryfullname" label="国家" align="center" min-width="100%"></el-table-column>
							<el-table-column prop="day" label="时间(天)" align="center" min-width="100%"></el-table-column>
							<el-table-column prop="growth" label="增长率" align="center" min-width="100%"></el-table-column>
						</el-table>
					</div>
				</el-col>
         ...
         <!-- 可持续城市 -->
        <div class="Economy Economy1">
 	         <h4>可持续城市和社区</h4>
			 <div id="sustainable" style="width: 100%;height: 500px;"></div>
        </div>	
        <!-- 经济增长和就业情况 -->
        <div class="Economy Economy2">
        	<h4>经济增长和就业情况</h4>
        	<div id="growth" style="width: 100%;height: 500px;"></div>
        	<div id="situation" style="width: 100%;height: 500px;"></div>
        </div>
        <!-- 创业和创新以及基础设施建设 -->
        <div class="Economy Economy3">
        	<h4>创业和创新以及基础设施建设</h4>
        	<div id="innovation" style="width: 100%;height: 500px;"></div>
        	<div id="development" style="width: 100%;height: 500px;"></div>
        </div>
        <!-- 全球合作伙伴 -->
        <div class="Economy Economy4">
        	<h4>全球合作伙伴</h4>
...
<script>
	...
	import {getCPIList,getGDPList,getStockPointList,Sustainable,Situation,Global,Innovation} from '@/api/economy/EconomyEventAnalysis'
	export default{
		data(){
			return{
				economyFormData:{
		...
		methods:{
			...
			loadStockPointPageList(){
                getStockPointList(this.stockpointVo).then(res=>{
                	...
                	this.StockPointTableData[i].day=formatterDateStr(this.StockPointTableData[i].day)
                   }
                });
			},
            selectEcnomy(){
            ...
            sustainable(){
            	...
            	SusCharts.setOption({
				    title: {
				        text: '主要国家细颗粒物（PM2.5）污染的安全水平。固体燃料的工业，运输和家庭使用是其中的来源',
				        subtext:'wbg_name（指标 =  “环境空气污染，PM2.5，年平均暴露”，denom  =  “每立方米微克数，ug / m3 ”，年份 =  年份）',
				        left: 'center',
				        top: 'top'
				    },
				    tooltip: {
            ...
            situation(){
               ...
               sitCharts.setOption({
	               	title: {
				        text: '获得金融服务有益于个人和社会。在全球范围内，69％的成年人拥有金融机构或移动货币提供者的账户',
				        subtext:'wbg_name（指标 =  “帐户所有权”，年份 =  年份，denom  =  “ 15岁及以上人口的百分比”）',
				        left: 'center',
				        top: 'top'
				    },
				    tooltip: {
            ...
            innovation(){
              ...
              innCharts.setOption({
              	title:{
              		text:'基础设施支持社区。如果没有全季节的道路，人们就会与关键服务和市场隔绝。'
              	},
              	 tooltip: {},
		   		 grid: [{
				        width: '40%',
				...
				xAxis: [{
				    ...
				    series: [
				        ...
				        },
				        {
				            ...
				            type:'line',
				            stack: '总量',
				            data:[220, 182, 191, 234, 290, 330, 310,120, 132, 101, 134, 90, 230, 310]
				        },
				        {
				            name:'视频广告',
				            type:'line',
