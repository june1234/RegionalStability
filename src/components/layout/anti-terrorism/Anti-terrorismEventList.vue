<template>
  <div class="AntiEventList">
    ...
    >
      ...
      >
        <el-select
          v-model="antiFormData.countryId"
          filterable
          placeholder="请选择国家"
        >
          <el-option
      ...
      >
        <el-select
          v-model="antiFormData.antiTerrorism"
          placeholder="请选择恐怖组织"
        >
          <!-- <el-option
      ...
      >
        <el-input
          v-model="antiFormData.keyswords"
          placeholder="请输入关键字"
        ></el-input>
      </el-form-item>
      <el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="恐怖组织">
          <el-select
            v-model="antiEvent.antiTerrorism"
            placeholder="请选择恐怖组织"
          >
