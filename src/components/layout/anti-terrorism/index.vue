<template>
	<div class="AntiEventAnalysis">
		...
		<!-- 反恐事件修改dialog -->
		<el-dialog title="反恐事件修改" style="text-align:center;" :visible.sync="antiEventUpdateDialog" width="50%">
			...
			ArmedForces(){
				...
				baseOption: {
					timeline: {
						...
						data: ['1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000',
							'2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008','汇总']
					},
					legend: {
						orient: 'vertical',
						left: 'left',
				...
				options: [
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 1992',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 1993',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 1994',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 1995',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 1996',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 1997',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 1998',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 1999',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2000',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2001',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2002',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2003',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2004',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2005',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2006',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2007',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India in 2008',
						x: 'center'
					},
					series: [{
						name: '武器类型',
					...
					title: {
						...
						subtext: 'An analysis of the armed forces of the terrorist attacks in India from 1992 to 2008',
						x: 'center'
					},
					series: [{
						name: '武器类型',
