...
<script>
	...
	import {getCPIList,getGDPList,getStockPointList} from '@/api/economy/EconomyEventAnalysis'
	export default{
		data(){
			return{
				economyFormData:{
		...
		methods:{
            ...
            situation(){
               ...
               sitCharts.setOption({
	               	title: {
				        text: '全球金库在金融机构或移动货币拥有的账户（2017年）',
				        left: 'center',
				        top: 'top'
				    },
				    tooltip: {
            ...
            Global(){
               ...
               GlobalCharts.setOption({
				    ...
				    visualMap: {
				        ...
				        calculable: true,
				        inRange: {
				            color: ['#ce0e48','#de7474', '#eb4c32','#f9d5cf',]
				        }
				    },
				    grid:{
						width:'90%'
